        ...
        <React.Fragment>
            ...
            <div className="relative z-10">
                ...
                <div className='bg-pure-greys-5 text-richblack-700 skills-section'>
                    <div className='homepage_bg h-[310px]'>
                        <div className='w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto'>
                            ...
                            <div className='flex flex-row gap-7 theme-text-primary'>
                                <CTAButton active={true} linkto={"/signup"}>
                    ...
                    <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            <div className='text-3xl lg:text-4xl font-semibold w-full lg:w-[45%] theme-text-primary'>
                ...
                <div className='mt-14 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 theme-text-primary'>
                    <InstructorSection />
                    <h1 className="text-center text-3xl lg:text-4xl font-semibold mt-8 flex justify-center items-center gap-x-3 theme-text-primary">
